...
const GDUploadFileScreen = () => {
      ...
      const files = [
        {
          name: 'test1',
          filename: 'test.txt',
          filepath: RNFS.DownloadDirectoryPath + '/test2.txt',
          filetype: 'txt'
        }]
        ...
        console.log('fileDetails : ' + JSON.stringify(files));
      // const fileDetails 
  ...
  const _uploadDriveDataImage = async () => {
    try {
      ...
      console.log("FILE PARTHHHHHHH",filePath)
      let fileContent = await RNFS.readFile(filePath.uri, 'base64');
      console.log("FILE PARTHHHHHHH 222",fileContent)
